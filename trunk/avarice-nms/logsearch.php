   ...
   <b class="rtop">
    ...
    <form class = "formtodiv" targetdiv = "results" action = "logsearch.php" method = "POST">
     <fieldset>
     	...
     	<label class="creds">FQDN or IP Target(s) | (csv)</label><input type=\"text\" name=\"fqdn\" />
			<label class="creds">Username (your)</label><input type=\"text\" name=\"user\" />
			<label class="creds">Password (your)</label><input type=\"password\" name=\"pass\" />
	    <input type = "hidden" name = "action" value = "search" />
	    <h3>Choose Log(s)</h3>
		  <label><input type = "radio" name = "logfile" value = "all" checked />All&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
      <label><input type = "radio" name = "logfile" value = "Application" />Application</label>
      <label><input type = "radio" name = "logfile" value = "Security" />Security</label>
      <label><input type = "radio" name = "logfile" value = "System" />System</label>
      <h3>Timeframe</h3>
      <label><input type = "radio" name = "timeframe" value = "-1 hour" checked />Last Hour&nbsp;</label>
      <label><input type = "radio" name = "timeframe" value = "-1 day" />Last Day</label>
      <label><input type = "radio" name = "timeframe" value = "-1 week" />Last Week</label>
      <label><input type = "radio" name = "timeframe" value = "-1 month" />Last Month</label><br />
